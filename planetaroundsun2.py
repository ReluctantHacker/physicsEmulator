...
EarthMass = 10     # standard earth Mass is 1

# Initial condition
ini_Sun_x = 0
ini_Sun_y = 0
ini_Sun_vx = 0.005   # initial x velocity 0.005 is standard, adjust this variable here
ini_Sun_vy = 0
...
tt = 1000    #Standard tt is 1000
dt = 1     #Standard dt is 1
